...
\say{{[}...{]} \acrfull{iot} este definit ca interconectarea computerelor și dispozitivelor prin internet, dând posibilitatea de a genera date ce pot servi analizei și creării de noi operațiuni. {[}...{]}}
